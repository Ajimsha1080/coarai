            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="clean-card p-8 rounded-2xl bg-white hover:bg-gray-50 transition-colors cursor-pointer group"
                    >
                        <div className="w-12 h-12 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center text-2xl mb-6 shadow-sm group-hover:bg-blue-600 group-hover:text-white transition-colors">
                    ...
                    <motion.div
                        ...
                        className="clean-card p-8 rounded-2xl bg-white hover:bg-violet-50/50 transition-colors cursor-pointer group"
                    >
                        <div className="w-12 h-12 rounded-xl bg-violet-100 text-violet-600 flex items-center justify-center text-2xl mb-6 shadow-sm group-hover:bg-violet-600 group-hover:text-white transition-colors">
                    ...
                    <motion.div
                        ...
                        className="clean-card p-8 rounded-2xl bg-white hover:bg-emerald-50/50 transition-colors cursor-pointer group"
                    >
                        <div className="w-12 h-12 rounded-xl bg-emerald-100 text-emerald-600 flex items-center justify-center text-2xl mb-6 shadow-sm group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                            <Rocket weight="bold" />
                        </div>
