...
import { Meta, Claude, Gemini } from '@lobehub/icons';

// SVG Paths for Real AI Brands
const LOGOS = [
    {
        name: "Gemini",
        component: <Gemini.Color size="100%" />
    },
    {
        name: "ChatGPT",
    ...
    {
        name: "Meta",
        component: <Meta.Color size="100%" />
    },
    {
        name: "Claude",
        component: <Claude.Color size="100%" />
    }
];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="text-5xl md:text-7xl font-display font-bold tracking-tight text-slate-900 mt-2 flex flex-wrap items-center justify-center gap-3"
                    >
                        <span>in</span>
